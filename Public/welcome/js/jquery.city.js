        ...
        initcity: function (e, p) {
            ...
            var option = {
                ...
                initChoice: function () {
                    ...
                    choicePopup +='<div class="city-bgcolor"></div>'
                    // choicePopup += '<span class="searchdet">直接搜索：</span><input type="text" class="city-inputval" placeholder="请输入城市中文或拼音">';
                    choicePopup += '<div class="city-head">';
                    choicePopup += '<ul class="city-tab" style="display:flex;">';
                ...
                initSearch: function (keyCode) {
                    ...
                    searchPopup += '<div class="city-search-bg"></div>'
                    searchPopup += '<ul class="city-search-item" style="width:124px;position:absolute;">';
                    searchPopup += '</ul>';
                    searchPopup += '</div>';

...
class NewPage {
    ...
    protected $coolPages;
    // 分页显示定制
    protected $config = array('header' => '条记录', 'prev' => '上一页', 'next' => '下一页', 'first' => '首页', 'last' => '尾页', 'theme' => "<span class=\"page_text\">%upPage%%linkPage%%downPage%");
    // 默认分页变量名
    protected $varPage;
    ...
    public function show() {
        ...
        $url = 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'].'/p/'.'__PAGE__';

...
class Page {
    ...
    public function show() {
        ...
        if ($upRow > 0) {
            $upPage = "<a  href='index.php?s=" . str_replace('__PAGE__', $upRow, $url) . "'>" . $this->config['prev'] . "</a>";
        } else {
            $upPage = "";
        }

        if ($downRow <= $this->totalPages) {
            $downPage = "<a href='index.php?s=" . str_replace('__PAGE__', $downRow, $url) . "'>" . $this->config['next'] . "</a>";
        } else {
            $downPage = "";
        }
        // << < > >>
        if ($this->nowPage == 1) {
            ...
            $prePage = "";
            $theFirst = "<a class='prev' href='index.php?s=" . str_replace('__PAGE__', 1, $url) . "' >" . $this->config['first'] . "</a>";
        }
        if ($this->nowPage == $this->totalPages) {
            ...
            $nextPage = "";
            $theEnd = "<a href='index.php?s=" . str_replace('__PAGE__', $theEndRow, $url) . "' >" . $this->config['last'] . "</a>";
        }
        ...
        for ($i = $preid; $i <= $endid; $i++) {
            if ($i != $this->nowPage) {
                $linkPage .= "<a href='index.php?s=" . str_replace('__PAGE__', $i, $url) . "'>" . $i . "</a>";
            } else {

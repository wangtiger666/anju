...
class MusicpointAction extends MemberAction {
    ...
    public function index() {
        ...
        foreach ($viewlist as $k => $view) {
            ...
            $vspotrow = M("Pano_musicpoint")->where($lwhere)->select();
    ...
    function view() {
        ...
        $roamrow = M("Pano_musicpoint")->where($roamwhere)->order("id")->select();
    ...
    function roam_add() {
        ...
        if (I("post.dopost") == "save") {
            ...
            $fileurl = "/uploads/user/" . substr(md5($this->member_id), 5, 15) . "/$pano_id/music";
            ...
            $add_id = M("Pano_musicpoint")->add($data);
    ...
    function roam_edit() {
        ...
        if (I("post.dopost") == "save") {
            ...
            M("Pano_musicpoint")->where($where)->save($data);
        ...
        $roamrow = M("Pano_musicpoint")->where($roamwhere)->find();
        $this->assign("roamrow", $roamrow);
    ...
    function roam_del() {
        ...
        M("Pano_musicpoint")->where($roamwhere)->delete();

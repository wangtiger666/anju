...
class WeblinkAction extends AdminAction{
    ...
    function del() {
        ...
        if ($_GET['id'] != "") {
            M("yun_weblink")->where("id=" . $_GET['id'])->delete();
        }
	...
	function edit()
	{
		...
		{	
            ...
            $posi_res = M("yun_weblink")->where(array("id"=>$id))->data($posidarr)->save();
   		...
   		$info = M("yun_weblink")->where(array("id"=>$id))->find();

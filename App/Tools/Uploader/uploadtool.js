...
function recheak(url){
	...
	else if("obj".indexOf(result)>=0){
        return upload_root+"/App/Tools/Uploader/images/obj.jpg";
    }
	else if("mtl".indexOf(result)>=0){
        return upload_root+"/App/Tools/Uploader/images/mtl.jpg";
    }
